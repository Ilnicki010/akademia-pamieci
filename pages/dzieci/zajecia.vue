    ...
    <transition name="slide-up">
      <section v-if="loaded">
        <header class="siteHeader">
          <h1>O ZAJĘCIACH</h1>
          <p>
            LEO MANIAK to program dla dzieci w wieku 8-13 lat.
            Zajęcia prowadzone są w 2 grupach wiekowych: 8-10 i 11-13 lat, spotkania 1 raz w tygodniu po 120 minut, 30 spotkań (60 godzin zajęć) w roku – grupy od 5 do max. 10 osób
        ...
        <div class="courseParts">
          <article class="part part--one">
            ...
            <p>W ramach zajęć programu Leo Maniak dzieci w atrakcyjny i wesoły sposób poznają ortografię języka polskiego. Poprzez barwne i zabawne obrazy zapamiętują pisownię konkretnych słów. Uczą się ortografii wszystkimi zmysłami, poprzez wzrok, słuch oraz ruch. Wprowadzane są w świat zasad ortografii, korzystając z zabaw, zagadek i rebusów. W tej części programu wprowadzamy pierwsze techniki ułatwiające koncentrację i ćwiczymy pamięć. Uczymy dzieci również żonglowania, co poza ciekawą formą ruchu jest dobrym ćwiczeniem na koncentrację, wpływa na lepszą koordynację ruchową oraz usprawnia współpracę dwóch półkul mózgowych.</p>
            <h3>
              <span>CZYTANIE I NOTOWANIE</span>
              <span>(19 SPOTKAŃ)</span>
            </h3>
            <p>Zajęcia mają charakter treningu. Dzieci poznają zestaw ćwiczeń, dzięki którym poprawiają tempo czytania, koncentrację oraz rozumienie tekstu i zapamiętywanie przeczytanych informacji. Poprzez systematyczny trening uczą się efektywnej pracy z tekstem – wybierają najistotniejsze informacje i odpowiadają pełnym zdaniem na pytania. Zajęcia wzbogacone są twórczymi działaniami związanymi z treścią czytanych tekstów, m.in. efektownymi eksperymentami naukowymi. Przedstawiamy dzieciom i trenujemy z nimi notowanie na zasadzie „map myśli”. Pokazujemy, jak wykorzystać „mapy myśli” do przygotowania pracy domowej, napisania planu wypracowania, powtórzenia materiału do sprawdzianu, itp. Kontynuujemy trening żonglowania.</p>
          </article>
